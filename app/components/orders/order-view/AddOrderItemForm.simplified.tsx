...
const AddOrderItemForm: React.FC<AddOrderItemFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate IDs for new items if they don't exist
      const itemToSubmit = {
        ...formData,
        // Generate temporary IDs for database references
        item_id: formData.item_id || crypto.randomUUID(),
        category_id: formData.category_id || crypto.randomUUID(),
      };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        <Button
          type="submit"
          disabled={isLoading || !formData.item_name || !formData.category_name || !formData.quantity || !formData.unit_price || !formData.size}
        >
          {isLoading ? (
            <>
