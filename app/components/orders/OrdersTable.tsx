  ...
  return (
    <div className="space-y-5">
        ...
        <div className="w-full sm:w-auto flex-1 flex flex-col sm:flex-row gap-2">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              className={`border-table-border bg-transparent hover:bg-table-hover text-table-header hover:text-white ${showFilters ? 'bg-foreground text-background' : ''}`}
            >
      ...
      <div className="table-container shadow-md">
        <div ref={tableContainerRef} className="overflow-x-auto overflow-y-hidden max-h-[650px] custom-scrollbar" style={{ scrollbarGutter: 'stable' }}>
          <table className="min-w-full divide-y divide-[hsl(var(--table-border))] table-fixed" role="grid" aria-label="Orders table">
            <thead className="table-header">

              <tr>
                <th scope="col" className="w-1/4 px-4 py-3 text-left text-sm font-medium uppercase tracking-wider" aria-sort={sortConfig.key === 'client_name' ? sortConfig.direction : 'none'}>
                  <button
                    className="flex items-center text-[hsl(var(--table-header-text))] hover:text-foreground focus:outline-none"
                ...
                <th scope="col" className="w-1/4 px-4 py-3 text-left text-sm font-medium uppercase tracking-wider">
                  <button
                    className="flex items-center text-[hsl(var(--table-header-text))] hover:text-foreground focus:outline-none"
                ...
                <th scope="col" className="w-1/4 px-4 py-3 text-right text-sm font-medium uppercase tracking-wider">
                  <button
            ...
            <motion.tbody
              className="divide-y divide-[hsl(var(--table-border))]"
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={8} className="px-4 py-6 text-center">
                    <p className="text-base text-[hsl(var(--table-header-text))]">No orders found</p>
