...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      // Theme tokens, not literal colours: the previous orange-600/gray-700
      // pair only read correctly in dark mode — an unchecked switch rendered
      // a dark grey track on a white card in light.
