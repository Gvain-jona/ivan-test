...
interface SWRSmartComboboxProps {
...
/**
 * A SmartCombobox component that uses SWR for data fetching
 * This replaces the GlobalDropdownCache-based components
 */
export function SWRSmartCombobox({
  entityType,
  parentId,
  value,
  onChange,
