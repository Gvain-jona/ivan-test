...
| list-parts | `app/components/orders/list/list-parts.tsx` | Yes | The list's figure, quick-action chip, filter chip and empty state; all wrap or truncate rather than overflow |
